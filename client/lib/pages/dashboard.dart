...
class _DashboardState extends State<Dashboard> {
  ...
  void initState() {
    super.initState();
    login().then((_) {
      DioService().getObjetivos().then((_) {
        setState(() {});
      });
    });
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Row(
          ...
          children: <Widget>[
            Text(style: TextStyle(color: Color(0XFF4EA8DE), fontWeight: FontWeight.w900), "Organização "),
            Text(style: TextStyle(color: Color(0XFF5E60CE), fontWeight: FontWeight.w900), "Pessoal"),
          ],
        ),
      ),
      body: Container(
